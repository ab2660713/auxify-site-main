...
import styles from '@/styles/logo-loader.module.css';

type LogoLoaderProps = Omit<React.ComponentPropsWithoutRef<'div'>, 'children'> & {
  label?: string;
  size?: React.CSSProperties['width'];
};

export const LogoLoader = React.forwardRef<HTMLDivElement, LogoLoaderProps>(
  (
    {
      className,
      label = 'Loading',
      role = 'status',
      size = 'clamp(5rem, 14vw, 8rem)',
    ...
    return (
      ...
      >
        <svg
          ...
          aria-hidden="true"
          focusable="false"
          className="drop-shadow-[0_18px_44px_rgb(1_75_170/0.18)]"
        >
